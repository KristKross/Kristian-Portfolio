                                ...
                                <div className="space-y-1">
                                    <div className="flex flex-wrap gap-x-6 gap-y-1">
                                        <button
                                            ...
                                            onClick={() => openWindow("mail", onOpenmail)}
                                            className={opened.mail ? "cursor-default text-[#6B7280]" : "cursor-pointer text-[#4FC1E9] transition-colors hover:text-white hover:underline"}
                                        >
                                            email
                                        </button>
                                        ...
                                        <button
                                            ...
                                            onClick={() => openWindow("github", onOpenGithub)}
                                            className={opened.github ? "cursor-default text-[#6B7280]" : "cursor-pointer text-[#4FC1E9] transition-colors hover:text-white hover:underline"}
                                        >
                                            github
                                        </button>
                                        ...
                                        <button
                                            ...
                                            onClick={() => openWindow("linkedin", onOpenLinkedin)}
                                            className={opened.linkedin ? "cursor-default text-[#6B7280]" : "cursor-pointer text-[#4FC1E9] transition-colors hover:text-white hover:underline"}
                                        >
                                            linkedin
                                        </button>
                                    </div>
